           ...
           <div className="flex gap-2">
             {!isSeller && product.status === 'available' && (
                <button
                  ...
                  className="px-4 py-1.5 bg-amber-400 hover:bg-amber-500 text-white rounded-lg text-xs font-bold transition-all shadow-sm shadow-amber-500/20"
                >
                  Kirim Penawaran
                </button>
             )}
              <button className="px-4 py-1.5 border-2 border-purple-600 text-purple-700 hover:bg-purple-50 rounded-lg text-xs font-bold transition-all">
                Atur Janji COD
              </button>
           </div>
        </div>
